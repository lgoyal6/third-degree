...
| Token | Value | Use |
|---|---|---|
| `--bg` | `#14100B` | Page background (warm charcoal, never pure black) |
| `--surface` | `#1D1712` | Cards, inputs |
| `--surface-2` | `#272019` | Elevated surfaces |
| `--line` | `#3B3226` | Borders |
| `--ink` | `#F3EDE3` | Foreground text |
| `--ink-muted` | `#A79A85` | Secondary text |
| `--lamp` | `#FFB224` | Accent / CTA (the lamp) |
| `--lamp-bright` | `#FFC95C` | Hover accent |
| `--ok` | `#58C08A` | Success / correct |
